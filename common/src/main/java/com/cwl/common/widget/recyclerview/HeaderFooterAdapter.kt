...
import com.cwl.common.widget.recyclerview.multitype.CommonViewHolder
import com.cwl.common.widget.recyclerview.multitype.MultiTypeAdapter
import com.cwl.common.widget.recyclerview.multitype.TypedItemView
 ...
 *  header footer 包装
 */
class HeaderFooterRecyclerViewAdapter(items: List<Any>) : MultiTypeAdapter(items) {
    companion object {
